...
ray start --head --port=6379 --num-cpus=4 --disable-usage-stats && ray start --address='127.0.0.1:6379' --num-cpus=4

# source .venv_train_dev/bin/activate && ray start --address='127.0.0.1:6379' --num-cpus=4
